...
store_version_name=テンプレート: テーマモジュール
store_version_description=この例のテーマは、このCMS内でテーマモジュール拡張機能の動作を示しています。さまざまなフォルダーの使用法を説明するreadmeファイルが含まれており、独自のテーマモジュールを作成するためのスケルトンテンプレートを提供します。
